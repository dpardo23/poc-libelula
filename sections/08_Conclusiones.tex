\section{Conclusiones}
    ...
    Comparativamente, frente a competidores como \textbf{Stripe}, \textbf{MercadoPago} o \textbf{PayPal}, Libélula es más 
    eficiente en costos y operación para transacciones uno a uno, pero carece de la flexibilidad necesaria para manejar 
    pagos multiproveedor. Las soluciones tradicionales, aunque más costosas y complejas, permiten gestionar carritos de 
    compra y pagos distribuidos, lo que las hace más adecuadas para modelos de negocio con múltiples beneficiarios.\par

    En síntesis, Libélula se posiciona como una pasarela de pagos \textbf{viable y competitiva} para transacciones directas 
    entre un cliente y un proveedor, ofreciendo eficiencia tecnológica, transparencia y costos optimizados. Sin embargo, no 
    es recomendable como solución principal para modelos de negocio donde un cliente deba pagar a múltiples proveedores, ya 
    que su diseño no soporta la distribución simultánea de fondos ni la gestión de pagos complejos.\par